...
exports.seedShelfLabel = exports.seedAssetTag = exports.seedProductLabel = exports.seedShippingLabel = exports.seedSalesReport = exports.seedStockReport = exports.seedAgedDebtorsReport = exports.seedCreditNotes = exports.seedDeliveryNotes = exports.seedPurchaseOrders = exports.seedStatements = exports.seedInvoices = exports.seedCustomers = exports.seedOrganisations = void 0;
exports.getSeedInputsForTemplate = getSeedInputsForTemplate;
exports.getSeedSummary = getSeedSummary;
exports.seedOrganisations = [
    {
        id: 'seed-org-alpha',
 ...
 */
function getSeedInputsForTemplate(templateType) {
    switch (templateType) {
        case 'invoice': {
            const inv = exports.seedInvoices[0];
            const cust = exports.seedCustomers.find(c => c.id === inv.customerId);
            const org = exports.seedOrganisations[0];
        ...
        case 'statement': {
            const stmt = exports.seedStatements[0];
            const cust = exports.seedCustomers.find(c => c.id === stmt.customerId);
            const org = exports.seedOrganisations[0];
        ...
        case 'purchase_order': {
            const po = exports.seedPurchaseOrders[0];
            const org = exports.seedOrganisations[0];
        ...
        case 'delivery_note': {
            const dn = exports.seedDeliveryNotes[0];
            const cust = exports.seedCustomers.find(c => c.id === dn.customerId);
            const org = exports.seedOrganisations[0];
        ...
        case 'credit_note': {
            const cn = exports.seedCreditNotes[0];
            const cust = exports.seedCustomers.find(c => c.id === cn.customerId);
            const org = exports.seedOrganisations[0];
        ...
        case 'report_aged_debtors': {
            const report = exports.seedAgedDebtorsReport;
        ...
        case 'report_stock_on_hand': {
            const report = exports.seedStockReport;
        ...
        case 'report_sales_summary': {
            const report = exports.seedSalesReport;
            // columns: customer, product, qty, revenue, cost, margin
            const tableRows = report.reps.flatMap(rep => rep.months.map(m => [
                rep.name,
                m.month,
                String(m.qty),
                formatZAR(m.revenue),
        ...
        case 'label': {
            ...
            const sl = exports.seedShippingLabel;
            return {
                ...
                'productName': exports.seedProductLabel.productName,
                'description': exports.seedProductLabel.description,
                'price': exports.seedProductLabel.price,
                'skuBarcode': exports.seedProductLabel.barcode,
                'skuText': exports.seedProductLabel.itemCode,
                // Asset tag fields
                'assetIdBarcode': exports.seedAssetTag.assetId,
                'assetQr': exports.seedAssetTag.assetId,
                'assetName': exports.seedAssetTag.assetName,
                'assetId': exports.seedAssetTag.assetId,
                'department': exports.seedAssetTag.department,
                'tagDate': exports.seedAssetTag.tagDate,
                // Shelf label fields
                'sku': exports.seedShelfLabel.sku,
                'barcode': exports.seedShelfLabel.barcode,
            };
        }
        default:
            return {};
...
function getSeedSummary() {
    return {
        organisations: exports.seedOrganisations.length,
        customers: exports.seedCustomers.length,
        invoices: exports.seedInvoices.length,
        statements: exports.seedStatements.length,
        purchaseOrders: exports.seedPurchaseOrders.length,
        deliveryNotes: exports.seedDeliveryNotes.length,
        creditNotes: exports.seedCreditNotes.length,
        reports: {
            agedDebtors: 1,
            stockOnHand: 1,
            salesSummary: 1,
