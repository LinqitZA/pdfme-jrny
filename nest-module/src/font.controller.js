...
function detectFontFormat(buffer) {
    ...
    if (head.equals(MAGIC.TTF))
        return 'ttf';
    if (head.equals(MAGIC.OTF))
        return 'otf';
    if (head.equals(MAGIC.WOFF2))
        return 'woff2';
    return null;
}
/**
 ...
 */
function readFsTypeFromFont(buffer) {
    if (buffer.length < 12)
        return null;
...
let FontController = class FontController {
    ...
    async uploadFont(file, req) {
        ...
        const result = await this.assetService.upload(user.orgId, file.originalname, file.buffer, file.mimetype);
        return {
            ...result,
            validation: {
                detectedFormat,
     ...
     */
    async downloadFont(fontId, req, res) {
        const user = req.user;
        if (!user?.orgId) {
            throw new common_1.HttpException({ statusCode: 400, error: 'Bad Request', message: 'orgId is required in JWT claims' }, common_1.HttpStatus.BAD_REQUEST);
        }
        ...
        const match = fontFiles.find((f) => f.includes(fontId));
        if (!match) {
            throw new common_1.HttpException({ statusCode: 404, error: 'Not Found', message: `Font ${fontId} not found` }, common_1.HttpStatus.NOT_FOUND);
        }
...
], FontController.prototype, "getSystemFonts", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof Express !== "undefined" && (_a = Express.Multer) !== void 0 && _a.File) === "function" ? _b : Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], FontController.prototype, "uploadFont", null);
tslib_1.__decorate([
    (0, common_1.Get)(),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], FontController.prototype, "listFonts", null);
tslib_1.__decorate([
    (0, common_1.Get)('cache/config'),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", void 0)
], FontController.prototype, "getFontCacheConfig", null);
tslib_1.__decorate([
    (0, common_1.Get)(':fontId'),
    tslib_1.__param(0, (0, common_1.Param)('fontId')),
    tslib_1.__param(1, (0, common_1.Req)()),
    tslib_1.__param(2, (0, common_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], FontController.prototype, "downloadFont", null);
tslib_1.__decorate([
    (0, common_1.Delete)(':fontId'),
    tslib_1.__param(0, (0, common_1.Param)('fontId')),
    tslib_1.__param(1, (0, common_1.Req)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], FontController.prototype, "deleteFont", null);
exports.FontController = FontController = tslib_1.__decorate([
    (0, common_1.Controller)('api/pdfme/fonts'),
