...
const fontkit = tslib_1.__importStar(require("fontkit"));
...
const preprocessing = async (arg) => {
    ...
    const plugins = (0, common_1.pluginRegistry)(Object.values(userPlugins).length > 0 ? userPlugins : schemas_1.builtInPlugins);
