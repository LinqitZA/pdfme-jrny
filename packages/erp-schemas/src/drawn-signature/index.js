...
exports.drawnSignature = exports.TRANSPARENT_PNG_DATA_URI = void 0;
/**
 * Placeholder 1x1 transparent PNG for fallback
 */
exports.TRANSPARENT_PNG_DATA_URI = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=';
/**
...
exports.drawnSignature = {
     ...
     */
    resolveSignatureData(signaturePngBuffer, fallback = 'blank') {
        ...
        if (fallback === 'placeholder') {
            ...
            return exports.TRANSPARENT_PNG_DATA_URI;
        }
