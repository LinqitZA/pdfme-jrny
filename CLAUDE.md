...
This command **requires** the project directory as an argument via `/home/linqadmin/repo/pdfme-jrny`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/app_spec.txt` and `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/initializer_prompt.md`

If `/home/linqadmin/repo/pdfme-jrny` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/`!
>
> **Files created:**
> - `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/app_spec.txt`
> - `/home/linqadmin/repo/pdfme-jrny/.autoforge/prompts/initializer_prompt.md`
>
...
- **Tool Priority Order**:
- **Context7 (highest priority)**:
Authoritative, current, version-aware documentation
1. mcp__context7__resolve-library-id with libraryName: "[library]"
2. mcp__context7__query-docs with libraryId: [resolved ID], query: "[question]"
- **Official Docs via WebFetch — Authoritative Sources**:
